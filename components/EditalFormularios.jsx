...
const EditalFormularios = ({ params }) => {
  ...
  const renderModalContent = () => (
    ...
    >
      ...
      <h4>{`Formulário de ${campoToEdit === 'PlanoDeTrabalho' ? 'Plano de Trabalho':campoToEdit}`}</h4>
      <p>{`O formulário selecionado servirá para o cadastro do ${campoToEdit === 'PlanoDeTrabalho' ? 'Plano de Trabalho':campoToEdit}`}</p>
