...
import styles from "./FluxoInscricaoGESTOR.module.scss";
import {
  RiAddCircleLine,
  RiAlertLine,
  RiArticleLine,
...
const FluxoInscricaoGESTOR = ({ tenant, inscricaoSelected }) => {
  // ESTADOS
  ...
  const handleStatusChange = async (e) => {
    ...
    try {
      const updatedInscricao = await updateInscricao(
        tenant,
        inscricaoSelected,
        {
          status: newStatus,
      ...
      setInscricao((prev) => ({
        ...prev,
        status: updatedInscricao.status,
      }));

      showSuccess("Status da inscrição atualizado com sucesso!");
    } catch (error) {
      console.error("Erro ao atualizar status:", error);
      showError(error, "Falha ao atualizar status da inscrição");
    } finally {
              ...
              {!notFound && (
                <div className={styles.header}>
                  ...
                  <div className={styles.statusDropdown}>
                    ...
                    />
                    {updatingStatus && <small>Atualizando...</small>}
                  </div>
                  {/* ITENS DO MENU */}
                  <div className={styles.stepsMenu}>
                    ...
                    >
                      {false && (
                        <div
                          className={`${styles.icon} ${styles.statusWarning}`}
                        >
                          <RiAlertLine />
                        </div>
                      )}
                                        ...
                                        <div className={styles.actions}>
                                          <div
                                            ...
                                            onClick={() => {
                                              ...
                                              setPlanoDeTrabalhoSelected(
                                                element
                                              );
                                              setIsModalOpenPlanoDeTrabalho(
                                                true
                                              );
                                            }}
                                          >
...
export default FluxoInscricaoGESTOR;
