...
const ItemForm = ({onEdit, onView, formulario, nomeFormulario,tipoFormulario}) => {
  
    return (
      <div className={styles.itemForm}>
                <p>{tipoFormulario==='PlanoDeTrabalho'?'Plano de Trabalho':tipoFormulario}</p>
