"use client";
import { RiIdCardLine, RiKeyLine } from "@remixicon/react";
import styles from "./CertificadoConteudo.module.scss";
...
export const CertificadoConteudo = ({ params, eventoId }) => {
          ...
          <div className="mt-4">
            ...
            <div className={styles.certificadosList}>
              {certificados.map((certificado) => (
                <Card key={certificado.id} className={styles.certificadoCard}>
                  ...
                  <div className={styles.certificadoActions}>
                    ...
                    <button
                      ...
                      onClick={() => handleVerFichaAvaliacao(certificado)}
