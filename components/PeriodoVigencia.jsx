...
const PeriodoVigencia = ({ params }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // Formata as datas para o formato YYYY-MM-DD (input type="date")
        ...
        setDates({
          inicio: formatDate(ed?.inicioVigencia),
          fim: formatDate(ed?.fimVigencia),
        });
      } catch (e) {
        console.error(e);
        toast.current?.show({
  ...
  const persistDate = async (field, value) => {
    if (!selectedEdital) return;
    const apiField = field === "inicio" ? "inicioVigencia" : "fimVigencia";
    ...
    <div className={styles.content}>
      ...
      <div className={styles.head}>
        ...
        <div className={styles.item}>
          ...
          <p>
            Selecione um edital e defina início e fim do período de vigência.
          </p>
          ...
          {selectedEdital && !loadingEdital && (
            <>
              ...
              <div className={styles.labelDate}>
                <label>
                  <p>O edital entra em vigor em:</p>
              ...
              <div className={styles.labelDate}>
                <label>
                  <p>O edital perde a validade em:</p>
                  <div className={styles.input}>
                    <div className={styles.icon}>
                      <RiCalendarCloseLine />
                    </div>
