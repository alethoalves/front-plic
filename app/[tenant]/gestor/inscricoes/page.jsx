...
// FUNÇÕES 
import { getEditais, getInscricoes, searchInscricoes } from '@/app/api/clientReq';
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <div><BuscadorBack onSearch={handleSearch} /></div>
        <div className={`${styles.content}`}>
          {loading ? <p>Carregando...</p> : (
            noResults ? <p>Nenhuma inscrição encontrada.</p> : 
