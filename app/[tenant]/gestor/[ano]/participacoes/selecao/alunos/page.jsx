...
// usado em TabelaPlanoDeTrabalhoAcompanhamento.jsx).
const getInitialFiltersAlunos = () => ({
...
const Page = ({ params }) => {
  ...
  const [filters, setFilters] = useState(getInitialFiltersAlunos());
  ...
  const limparFiltros = () => {
    setFilters(getInitialFiltersAlunos());
