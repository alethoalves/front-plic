...
import { getAvaliacoesPendentes } from "@/app/api/client/avaliador";
...
const Page = ({ params }) => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const avaliacoesPendentes = await getAvaliacoesPendentes(params.tenant);
      const data = avaliacoesPendentes; //await getSubmissoesSemAvaliacao(params.idInstituicao);
      setSubmissoes(data);
