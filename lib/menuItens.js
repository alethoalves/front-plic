// menuItems.js
import { RiCouponLine, RiFile2Line, RiFileChartLine, RiFilter2Line, RiFoldersLine, RiGroupLine, RiHomeLine, RiListCheck2, RiQuestionAnswerLine, RiQuillPenLine, RiRefund2Line, RiScales3Line, RiSearch2Line, RiSettings3Line, RiSettingsLine, RiSurveyLine, RiTodoLine, RiUser2Line, RiUserLine } from "@remixicon/react";
...
const itensMenu = [
  ...
  {group:{
    ...
    itens:[ 
      {title: "Avaliadores", 
      path: "/[tenant]/gestor/[ano]/avaliacoes/projetos/avaliadores"},
      {title: "Projetos",
        path: "/[tenant]/gestor/[ano]/avaliacoes/projetos/distribuicao-projetos"},
      {title: "Recursos",
        path: "/[tenant]/gestor/[ano]/avaliacoes/projetos/distribuicao-recursos"},
      {title: "Acompanhar",
  ...
  {group:{
    ...
    itens:[ 
      {title: "Projetos",
      path: "/[tenant]/gestor/[ano]/avaliacoes/projetos/selecao/projetos"},
      {title: "Planos de Trabalho",
      path: "/[tenant]/gestor/[ano]/avaliacoes/projetos/selecao/planos-de-trabalho"},
      {title: "Orientadores",
        path: "/[tenant]/gestor/[ano]/participacoes/selecao/orientadores"},
      {title: "Alunos",
  ...
  { title: "Atividades", icon: RiListCheck2, path: "/[tenant]/gestor/[ano]/atividades" },
  { title: "Documentos", icon: RiFile2Line, path: "/[tenant]/gestor/[ano]/documentos" },
